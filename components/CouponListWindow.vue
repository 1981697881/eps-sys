    ...
    <view class="coupon-list-window" :class="value === true ? 'on' : ''">
      ...
      <view v-if="couponList.length > 0">
        <view class="coupon-list">
          <div class="item acea-row row-center-wrapper" v-for="coupon in couponList" :key="coupon.id" @click="click(coupon)">
            <div class="money">
              <div>
            ...
            <div class="text">
              ...
              <div class="data acea-row row-between-wrapper">
                ...
                <div class="iconfont icon-xuanzhong1 font-color-red" v-if="checked === coupon.id"></div>
