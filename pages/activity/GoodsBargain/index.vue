<template>
  <view class="bargain-list">
    ...
    <view class="list" v-if="bargainLis.length > 0">
      <view class="item acea-row row-between-wrapper" v-for="(item, bargainLisIndex) in bargainLis" :key="bargainLisIndex">
        <view class="pictrue">
        ...
        <view class="cutBnt bg-color-red" @click="goDetail(item.id)"> <text class="iconfont icon-kanjia"></text>参与砍价 </view>
      </view>
