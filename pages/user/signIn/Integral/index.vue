<template>
  <view class="integral-details" ref="container">
    ...
    <view class="wrapper">
      <view class="nav acea-row">
        <view class="item acea-row row-center-wrapper" :class="current === navListIndex ? 'on' : ''" v-for="(item, navListIndex) in navList" :key="navListIndex" @click="nav(navListIndex)">
      ...
      <view class="list" :hidden="current !== 0">
        ...
        <!--</view>-->
        <view class="item acea-row row-between-wrapper" v-for="(item, listIndex) in list" :key="listIndex">
          <view>
