<template>
  <view class="order-index" ref="container">
    ...
    <view class="wrapper">
      <view class="title"> <text class="iconfont icon-shujutongji"></text>数据统计 </view>
    ...
    <view class="public-wrapper">
      <view class="title"> <text class="iconfont icon-xiangxishuju"></text>详细数据 </view>
      ...
      <view class="conter">
        <view class="item acea-row row-between-wrapper" v-for="(item, orderListIndex) in list" :key="orderListIndex">
