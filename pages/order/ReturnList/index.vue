<template>
  <view class="return-list" ref="container">
    <view class="goodWrapper" v-for="(order, orderListIndex) in orderList" :key="orderListIndex">
      ...
      <view class="item acea-row row-between-wrapper" v-for="(cart, cartInfoIndex) in order.cartInfo" :key="cartInfoIndex" @click="goOrderDetails(order)">
        <view class="pictrue">
      ...
      <view class="totalSum">
        ...
        <text class="font-color-red price">￥{{ order.payPrice }}</text>
      </view>
    </view>
